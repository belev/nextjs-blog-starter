...
I am feeling grateful and want to thank Jafar Husain for the wonderful course [Asynchronous Programming in JS (with Rx.js Observables)](https://frontendmasters.com/courses/asynchronous-javascript/) from which I learned so much and found the solution. The course is also available in Pluralsight - [link](https://www.pluralsight.com/courses/asynchronous-javascript-rxjs-observables).
